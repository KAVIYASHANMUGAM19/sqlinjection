...
![output](<sql/image4.png>)

Click on the link “Please register here”
##  OUTPUT

![output](<sql/image5.png>)

Click on “Create Account” to display the following page:
##  OUTPUT

![output](<sql/image6.png>)
...
![output](<sql/image20.png>)

Replace ‘metasploit’ with ‘owasp10’ and make sure the lines end with semicolon ; as shown in Figure
##  OUTPUT


![output](<sql/image7.png>)
...
![output](<sql/image12.png>)
Click the login button and you will see it enter into the administrator page.
#OUTPUT

![output](<sql/image11.png>)
...
![output](<Screenshot 2025-11-01 145406.png>)
...
![output](<sql/image22.png>)


Instead of using the "order by" option, let’s use the "union select" option and provide all five columns. Ex: (union select 1,2,3,4,5).
##  OUTPUT

![output](<sql/image14.png>)
...
![alt text](<sql/image16.png>)

![alt text](<sql/image17.png>)
