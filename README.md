...
![alt text](<Screenshot 2025-11-01 142439.png>)

Replace ‘metasploit’ with ‘owasp10’ and make sure the lines end with semicolon ; as shown in Figure
##  OUTPUT


![alt text](<Screenshot 2025-11-01 143418.png>)
...
![alt text](<Screenshot 2025-11-01 143653.png>)
...
![alt text](<Screenshot 2025-10-30 093139.png>)
Click the login button and you will see it enter into the administrator page.
#OUTPUT

![alt text](<Screenshot 2025-10-30 091720-1.png>)
...
![alt text](<Screenshot 2025-11-01 150152.png>)
From this point, all our attack vectors will be performed in the URL section of the page using the Union-Based technique.There are two different ways to discover how many columns are selected by the original query. The first is to infuse an “ORDER BY” statement indicating a column number. Given the column number specified is higher than the number of columns in the “SELECT” statement, an error will be returned.
##  OUTPUT

![alt text](<Screenshot 2025-10-30 091707-1.png>)
...
![alt text](<Screenshot 2025-11-01 145406.png>)
...
![alt text](<Screenshot 2025-11-01 145406-1.png>)
...
![alt text](<Screenshot 2025-10-31 133931-1.png>)


Instead of using the "order by" option, let’s use the "union select" option and provide all five columns. Ex: (union select 1,2,3,4,5).
##  OUTPUT

![alt text](<Screenshot 2025-10-31 133931.png>)
...
![alt text](<Screenshot 2025-10-31 134150.png>)
...
![alt text](<Screenshot 2025-10-31 134520.png>)

![alt text](<Screenshot 2025-10-31 134551-1.png>)
...
![alt text](<Screenshot 2025-11-01 145915.png>)
## RESULT:
